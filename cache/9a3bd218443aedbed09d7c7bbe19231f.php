...
<body>
	...
	<header>
		...
		<div style="float:right;width:200px;height:30px;margin:50px;">
			...
			<a href="index.php?m=User&a=music" style="float:right;" target="_blank">&nbsp;music </a>
	...
	<article>
		...
		<div class="bloglist left">
			...
			<figure>
				<a href="index.php?m=Article&a=details&aid=<?=$value['aid'];?>">
					<img src="<?=$value['path'];?>" alt="php精选" width="175" height="130"/>
				</a>
			</figure>
			<ul>
				<p>
		...
		<aside class="right" style="float:right;position:absolute;top:357px;right:130px;">
