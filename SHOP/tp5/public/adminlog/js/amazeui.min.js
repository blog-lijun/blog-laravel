/*! Amaze UI v2.6.1 | by Amaze UI Team | (c) 2016 AllMobilize, Inc. | Licensed under MIT | 2016-04-06T09:34:39+0800 */ ! function(t, e) {
	...
	return function(t) {
		...
		var n = i(1),
			o = i(2);
		i(3), i(4), i(5), i(6), i(7), i(8), i(9), i(10), i(11), i(14), i(15), i(16), i(17), i(18), i(19), i(20), i(21), i(22), i(24), i(25), i(23), i(27), i(28), i(29), i(30), i(31), i(32), i(33), i(26), i(34), i(35), i(36), i(37), i(38), i(39), i(40), i(41), i(42), i(43), i(44), i(45), i(46), i(47), i(48), i(49), i(50), i(51), i(52), i(53), i(54), t.exports = n.AMUI = o
	}, function(e, i) {
		e.exports = t
	}, function(t, e, i) {
		"use strict";
		...
		var o = n.AMUI || {},
			...
			a = window.document,
			r = n("html");
		o.VERSION = "2.6.1", o.support = {}, o.support.transition = function() {
			var t = function() {
		...
		}(), o.support.touch = "ontouchstart" in window && navigator.userAgent.toLowerCase().match(/mobile|tablet/) || window.DocumentTouch && document instanceof window.DocumentTouch || window.navigator.msPointerEnabled && window.navigator.msMaxTouchPoints > 0 || window.navigator.pointerEnabled && window.navigator.maxTouchPoints > 0 || !1, o.support.mutationobserver = window.MutationObserver || window.WebKitMutationObserver || null, o.support.formValidation = "function" == typeof document.createElement("form").checkValidity, o.utils = {}, o.utils.debounce = function(t, e, i) {
			var n;
			return function() {
				var o = this,
					s = arguments,
			...
			return e = n.extend({
				topOffset: 0,
				leftOffset: 0
			}, e), h + i.height() >= r && h - e.topOffset <= r + s.height() && c + i.width() >= a && c - e.leftOffset <= a + s.width()
				...
				var a, r = Array.prototype.slice.call(arguments, 0),
					...
					c = this.each(function() {
						var c = n(this),
							...
							d = c.data(h),
							p = n.extend({}, o.utils.parseOptions(c.attr(u)), "object" == typeof s && s);
						(d || "destroy" !== s) && (d || c.data(h, d = new e(this, p)), i.methodCall ? i.methodCall.call(c, r, d) : (i.before && i.before.call(c, r, d), "string" == typeof s && (a = "function" == typeof d[s] ? d[s].apply(d, l) : d[s]), i.after && i.after.call(c, r, d)))
					});
				return void 0 === a ? c : a
			}, n.fn[t].Constructor = e, n.fn[t].noConflict = function() {
				return n.fn[t] = s, this
			}, o[t] = e
		}, n.fn.emulateTransitionEnd = function(t) {
			var e = !1,
				i = this;
			n(this).one(o.support.transition.end, function() {
				e = !0
			});
			var s = function() {
				e || n(i).trigger(o.support.transition.end), i.transitionEndTimmer = void 0
			};
			...
			return this.each(function(t) {
				...
				var i = [];
				e = e.split(" ");
				for (var o = 0, s = e.length; s > o; o++) e[o].match(t) || i.push(e[o]);
		...
		}, o.template.cache = {}, o.template.get = function(t) {
			if (t) {
				var e = document.getElementById(t);
				return e && e.innerHTML || ""
			}
		}, o.DOMWatchers = [], o.DOMReady = !1, o.ready = function(t) {
			o.DOMWatchers.push(t), o.DOMReady && t(document)
		...
		}, o.support.touch && r.addClass("am-touch"), n(document).on("changed.dom.amui", function(t) {
			var e = t.target;
			n.each(o.DOMWatchers, function(t, i) {
				i(e)
			})
		}), n(function() {
			var t = n("body");
			o.DOMReady = !0, n.each(o.DOMWatchers, function(t, e) {
				e(document)
			}), o.DOMObserve("[data-am-observe]"), r.removeClass("no-js").addClass("js"), o.support.animation && r.addClass("cssanimations"), window.navigator.standalone && r.addClass("am-standalone"), n(".am-topbar-fixed-top").length && t.addClass("am-with-topbar-fixed-top"), n(".am-topbar-fixed-bottom").length && t.addClass("am-with-topbar-fixed-bottom");
			var e = n(".am-layout");
		...
		function r(t, e, i) {
			var n, o = e.prototype;
			n = t.prototype = Object.create(o), n.constructor = t, n._super = o, i && at(n, i)
		}
		...
		function S(t, e) {
			...
			var s = i.firstInput,
				...
				l = e.center = A(n);
			e.timeStamp = mt(), e.deltaTime = e.timeStamp - s.timeStamp, e.angle = N(r, l), e.distance = P(r, l), k(i, e), e.offsetDirection = M(e.deltaX, e.deltaY);
			var c = $(e.deltaTime, e.deltaX, e.deltaY);
			e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = pt(c.x) > pt(c.y) ? c.x : c.y, e.scale = a ? O(a.pointers, n) : 1, e.rotation = a ? I(a.pointers, n) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, D(i, e);
			var h = t.element;
		...
		function D(t, e) {
			...
			if (e.eventType != $t && (r > kt || void 0 === a.velocity)) {
				var l = e.deltaX - a.deltaX,
					c = e.deltaY - a.deltaY,
					h = $(r, l, c);
				n = h.x, o = h.y, i = pt(h.x) > pt(h.y) ? h.x : h.y, s = M(l, c), t.lastInterval = e
		...
		function L() {
			this.evEl = Ht, this.evWin = Vt, this.allow = !0, this.pressed = !1, x.apply(this, arguments)
		}

		function _() {
			this.evEl = Xt, this.evWin = Yt, x.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
		}

		function z() {
			this.evTarget = Zt, this.evWin = Gt, this.started = !1, x.apply(this, arguments)
		}

		function R(t, e) {
			var i = g(t.touches),
				n = g(t.changedTouches);
			return e & (At | $t) && (i = w(i.concat(n), "identifier", !0)), [i, n]
		}
		...
		function W(t, e) {
			var i = g(t.touches),
				n = this.targetIds;
			if (e & (Dt | Ft) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
			...
			for (o = 0; o < a.length;) n[a[o].identifier] && r.push(a[o]), e & (At | $t) && delete n[a[o].identifier], o++;
		...
		function U(t) {
			this.options = at({}, this.defaults, t || {}), this.id = b(), this.manager = null, this.options.enable = h(this.options.enable, !0), this.state = re, this.simultaneous = {}, this.requireFail = []
		}
		...
		function it(t, e) {
			return e = e || {}, e.recognizers = h(e.recognizers, it.defaults.preset), new nt(t, e)
		}

		function nt(t, e) {
			this.options = at({}, it.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = C(this), this.touchAction = new V(this, this.options.touchAction), ot(this, !0), s(this.options.recognizers, function(t) {
		...
		function ot(t, e) {
			var i = t.element;
			i.style && s(t.options.cssProps, function(t, n) {
		...
		r(L, x, {
			handler: function(t) {
				var e = Wt[t.type];
				e & Dt && 0 === t.button && (this.pressed = !0), e & Ft && 1 !== t.which && (e = At), this.pressed && this.allow && (e & At && (this.pressed = !1), this.callback(this.manager, e, {
					pointers: [t],
					changedPointers: [t],
					pointerType: Et,
					srcEvent: t
		...
		window.MSPointerEvent && !window.PointerEvent && (Xt = "MSPointerDown", Yt = "MSPointerMove MSPointerUp MSPointerCancel"), r(_, x, {
			handler: function(t) {
				var e = this.store,
					i = !1,
				...
				o & Dt && (0 === t.button || a) ? 0 > r && (e.push(t), r = e.length - 1) : o & (At | $t) && (i = !0), 0 > r || (e[r] = t, this.callback(this.manager, o, {
					pointers: e,
					changedPointers: [t],
					pointerType: s,
					srcEvent: t
		...
		r(z, x, {
			handler: function(t) {
				...
				if (e === Dt && (this.started = !0), this.started) {
					...
					e & (At | $t) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
						pointers: i[0],
						changedPointers: i[1],
						pointerType: xt,
						srcEvent: t
		...
		r(q, x, {
			...
			handler: function(t, e, i) {
				...
				e & (At | $t) && (this.mouse.allow = !0), this.callback(t, e, i)
			},
			destroy: function() {
		...
		V.prototype = {
			set: function(t) {
				t == ee && (t = this.compute()), te && this.manager.element.style && (this.manager.element.style[Qt] = t), this.actions = t.toLowerCase().trim()
			},
			update: function() {
		...
		U.prototype = {
			...
			emit: function(t) {
				...
				var i = this,
					n = this.state;
				he > n && e(i.options.event + X(n)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), n >= he && e(i.options.event + X(n))
			},
			tryEmit: function(t) {
			...
			getTouchAction: function() {
				var t = this.options.direction,
					e = [];
				return t & Lt && e.push(ae), t & _t && e.push(se), e
			},
			directionTest: function(t) {
				var e = this.options,
					...
					s = t.deltaX,
					a = t.deltaY;
				return o & e.direction || (e.direction & Lt ? (o = 0 === s ? Mt : 0 > s ? Pt : Nt, i = s != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === a ? Mt : 0 > a ? It : Ot, i = a != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
			},
			attrTest: function(t) {
			...
			process: function(t) {
				...
				else if (t.eventType & Dt) this.reset(), this._timer = n(function() {
			...
			attrTest: function(t) {
				...
				return i & (Lt | _t) ? e = t.overallVelocity : i & Lt ? e = t.overallVelocityX : i & _t && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && pt(e) > this.options.velocity && t.eventType & At
			},
			emit: function(t) {
		...
		nt.prototype = {
				...
				recognize: function(t) {
					...
					if (!e.stopped) {
						...
						for (var s = 0; s < n.length;) i = n[s], e.stopped === fe || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (le | ce | he) && (o = e.curRecognizer = i), s++
					}
				},
				get: function(t) {
		...
		}), o.language = o.language && o.language in o.intl ? o.language : "en_us", o.isMobileSafari = o.isIDevice && m.indexOf("Safari") > -1 && m.indexOf("CriOS") < 0, o.OS = o.isIDevice ? "ios" : o.isMobileChrome ? "android" : o.isMobileIE ? "windows" : "unsupported", o.OSVersion = m.match(/(OS|Android) (\d+[_\.]\d+)/), o.OSVersion = o.OSVersion && o.OSVersion[2] ? +o.OSVersion[2].replace("_", ".") : 0, o.isStandalone = "standalone" in window.navigator && window.navigator.standalone, o.isTablet = o.isMobileSafari && m.indexOf("iPad") > -1 || o.isMobileChrome && m.indexOf("Mobile") < 0, o.isCompatible = o.isMobileSafari && o.OSVersion >= 6 || o.isMobileChrome;
		var v = {
			lastDisplayTime: 0,
			returningVisitor: !1,
			displayCount: 0,
		...
		o.removeSession = function(t) {
			...
			if (this.doLog = o.doLog, this.options = s({}, o.defaults), s(this.options, t), this.options.debug && (this.options.logging = !0), l) {
				...
				if (o.isStandalone) return this.session.added || (this.session.added = !0, this.updateSession(), this.options.onAdd && o.hasLocalStorage && this.options.onAdd.call(this)), void this.doLog("Add to homescreen: not displaying callout because in standalone mode");
				if (this.options.detectHomescreen) {
					if (o.hasToken) return a(), this.session.added || (this.session.added = !0, this.updateSession(), this.options.onAdd && o.hasLocalStorage && this.options.onAdd.call(this)), void this.doLog("Add to homescreen: not displaying callout because URL has token, so we are likely coming from homescreen");
		...
		}, o.VERSION = "3.2.2", t.exports = r.addToHomescreen = o
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
			o = i(2),
		...
		s.DEFAULTS = {
			...
			var e = this.$element;
			e.trigger("close.alert.amui").removeClass("am-in"), o.support.transition && e.hasClass("am-fade") ? e.one(o.support.transition.end, t).emulateTransitionEnd(200) : t()
		}, o.plugin("alert", s), n(document).on("click.alert.amui.data-api", "[data-am-alert]", function(t) {
			var e = n(t.target);
		...
		var n = i(1),
			o = i(2),
			s = function(t, e) {
				this.$element = n(t), this.options = n.extend({}, s.DEFAULTS, e), this.isLoading = !1, this.hasSpinner = !1
			};
		s.DEFAULTS = {
			loadingText: "loading...",
			...
			t += "Text", r.resetText || (r.resetText = i[l]()), o.support.animation && r.spinner && "html" === l && !this.hasSpinner && (r.loadingText = '<span class="am-icon-' + r.spinner + ' am-icon-spin"></span>' + r.loadingText, this.hasSpinner = !0), e = e || (void 0 === a[t] ? r[t] : a[t]), i[l](e), setTimeout(n.proxy(function() {
		...
		a.DEFAULTS = {
			...
			"zh_CN" === this.language ? l.text(e + a.locales[this.language].year[0] + " " + a.locales[this.language].months[i]) : l.text(a.locales[this.language].months[i] + " " + e), o.setDate(s), o.setDate(s - (o.getDay() - this.weekStart + 7) % 7);
			var c = new Date(o);
			c.setDate(c.getDate() + 42), c = c.valueOf();
			for (var h, u, d, p = []; o.valueOf() < c;) o.getDay() === this.weekStart && p.push("<tr>"), h = this.onRender(o, 0), u = o.getFullYear(), d = o.getMonth(), i > d && u === e || e > u ? h += " am-datepicker-old" : (d > i && u === e || u > e) && (h += " am-datepicker-new"), o.valueOf() === n && (h += " am-active"), p.push('<td class="am-datepicker-day ' + h + '">' + o.getDate() + "</td>"), o.getDay() === this.weekEnd && p.push("</tr>"), o.setDate(o.getDate() + 1);
		...
		var n = i(1),
			...
			r = function() {
				this.id = o.utils.generateGUID("am-dimmer"), this.$element = n(r.DEFAULTS.tpl, {
					id: this.id
		...
		r.DEFAULTS = {
			...
			return this.inited || (n(document.body).append(this.$element), this.inited = !0, s.trigger("init.dimmer.amui"), this.$element.on("touchmove.dimmer.amui", function(t) {
				t.preventDefault()
			})), this
		...
		a.DEFAULTS = {
			...
			if (!e.is(".am-disabled, :disabled") && !this.active) {
				...
				s ? (this.animating = 1, o.addClass(this.options.animation).on(s.end + ".open.dropdown.amui", n.proxy(function() {
					a(), o.removeClass(this.options.animation)
				}, this))) : a()
			}
		}, a.prototype.close = function() {
			if (this.active) {
				...
				s ? (i.removeClass(this.options.animation), i.addClass(t), this.animating = 1, i.one(s.end + ".close.dropdown.amui", function() {
					i.removeClass(t), o()
				})) : o()
			}
		...
		}, o.plugin("dropdown", a), o.ready(function(t) {
		...
		(function(e) {
			...
			n.flexslider = function(t, i) {
				var o = n(t);
				o.vars = n.extend({}, n.flexslider.defaults, i);
				...
				n.data(t, "flexslider", o), g = {
					init: function() {
						o.animating = !1, o.currentSlide = parseInt(o.vars.startAt ? o.vars.startAt : 0, 10), isNaN(o.currentSlide) && (o.currentSlide = 0), o.animatingTo = o.currentSlide, o.atEnd = 0 === o.currentSlide || o.currentSlide === o.last, o.containerSelector = o.vars.selector.substr(0, o.vars.selector.search(" ")), o.slides = n(o.vars.selector, o), o.container = n(o.containerSelector, o), o.count = o.slides.length, o.syncExists = n(o.vars.sync).length > 0, "slide" === o.vars.animation && (o.vars.animation = "swing"), o.prop = d ? "top" : "marginLeft", o.args = {}, o.manualPause = !1, o.stopped = !1,
							o.started = !1, o.startTimeout = null, o.transitions = !o.vars.video && !f && o.vars.useCSS && function() {
								var t = document.createElement("div"),
									e = ["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"];
								for (var i in e)
									if (void 0 !== t.style[e[i]]) return o.pfx = e[i].replace("Perspective", "").toLowerCase(), o.prop = "-" + o.pfx + "-transform", !0;
								return !1
							}(), o.ensureAnimationEnd = "", "" !== o.vars.controlsContainer && (o.controlsContainer = n(o.vars.controlsContainer).length > 0 && n(o.vars.controlsContainer)), "" !== o.vars.manualControls && (o.manualControls = n(o.vars.manualControls).length > 0 && n(o.vars.manualControls)), "" !== o.vars.customDirectionNav && (o.customDirectionNav = 2 === n(o.vars.customDirectionNav).length && n(o.vars.customDirectionNav)), o.vars.randomize && (o.slides.sort(function() {
								return Math.round(Math.random()) - .5
							}), o.container.empty().append(o.slides)), o.doMath(), o.setup("init"), o.vars.controlNav && g.controlNav.setup(), o.vars.directionNav && g.directionNav.setup(), o.vars.keyboard && (1 === n(o.containerSelector).length || o.vars.multipleKeyboard) && n(document).bind("keyup", function(t) {
								var e = t.keyCode;
							...
							}), o.vars.pauseInvisible && g.pauseInvisible.isHidden() || (o.vars.initDelay > 0 ? o.startTimeout = setTimeout(o.play, o.vars.initDelay) : o.play())), v && g.asNav.setup(), c && o.vars.touch && g.touch(), (!f || f && o.vars.smoothHeight) && n(window).bind("resize orientationchange focus", g.resize), o.find("img").attr("draggable", "false"), setTimeout(function() {
								o.vars.start(o)
							}, 200)
					},
					asNav: {
						setup: function() {
							o.asNav = !0, o.animatingTo = Math.floor(o.currentSlide / o.move), o.currentItem = o.currentSlide, o.slides.removeClass(r + "active-slide").eq(o.currentItem).addClass(r + "active-slide"), l ? (t._slider = o, o.slides.each(function() {
								var t = this;
					...
					controlNav: {
						...
						setupPaging: function() {
							var t, e, i = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging",
								s = 1;
							if (o.controlNavScaffold = n('<ol class="' + r + "control-nav " + r + i + '"></ol>'), o.pagingCount > 1)
								for (var a = 0; a < o.pagingCount; a++) {
									...
									o.controlNavScaffold.append("<li>" + t + "<i></i></li>"), s++
								}
							o.controlsContainer ? n(o.controlsContainer).append(o.controlNavScaffold) : o.append(o.controlNavScaffold), g.controlNav.set(), g.controlNav.active(), o.controlNavScaffold.delegate("a, img", h, function(t) {
						...
						setupManual: function() {
							o.controlNav = o.manualControls, g.controlNav.active(), o.controlNav.bind(h, function(t) {
								if (t.preventDefault(), "" === u || u === t.type) {
									var e = n(this),
										i = o.controlNav.index(e);
						...
						update: function(t, e) {
							o.pagingCount > 1 && "add" === t ? o.controlNavScaffold.append(n('<li><a href="#">' + o.count + "</a></li>")) : 1 === o.pagingCount ? o.controlNavScaffold.find("li").remove() : o.controlNav.eq(e).closest("li").remove(), g.controlNav.set(), o.pagingCount > 1 && o.pagingCount !== o.controlNav.length ? o.update(e, t) : g.controlNav.active()
						}
					},
					directionNav: {
						setup: function() {
							...
							o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (n(o.controlsContainer).append(t), o.directionNav = n("." + r + "direction-nav li a", o.controlsContainer)) : (o.append(t), o.directionNav = n("." + r + "direction-nav li a", o)), g.directionNav.update(), o.directionNav.bind(h, function(t) {
								t.preventDefault();
								var e;
								"" !== u && u !== t.type || (e = n(this).hasClass(r + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(e, o.vars.pauseOnAction)), "" === u && (u = t.type), g.setToClearWatchedEvent()
							})
						},
						update: function() {
							var t = r + "disabled";
					...
					pausePlay: {
						setup: function() {
							...
							o.controlsContainer ? (o.controlsContainer.append(t), o.pausePlay = n("." + r + "pauseplay a", o.controlsContainer)) : (o.append(t), o.pausePlay = n("." + r + "pauseplay a", o)), g.pausePlay.update(o.vars.slideshow ? r + "pause" : r + "play"), o.pausePlay.bind(h, function(t) {
								t.preventDefault(), "" !== u && u !== t.type || (n(this).hasClass(r + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === u && (u = t.type), g.setToClearWatchedEvent()
							})
						},
						update: function(t) {
					...
					touch: function() {
						function i(e) {
							e.stopPropagation(), o.animating ? e.preventDefault() : (o.pause(), t._gesture.addPointer(e.pointerId), C = 0, h = d ? o.h : o.w, v = Number(new Date), c = m && p && o.animatingTo === o.last ? 0 : m && p ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : m && o.currentSlide === o.last ? o.limit : m ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : p ? (o.last - o.currentSlide + o.cloneOffset) * h : (o.currentSlide + o.cloneOffset) * h)
						}
						...
						function n(i) {
							...
							if (n) {
								var o = -i.translationX,
									s = -i.translationY;
								return C += d ? s : o, u = C, b = d ? Math.abs(C) < Math.abs(-o) : Math.abs(C) < Math.abs(-s), i.detail === i.MSGESTURE_FLAG_INERTIA ? void e(function() {
									t._gesture.stop()
						...
						l ? (t.style.msTouchAction = "none", t._gesture = new MSGesture, t._gesture.target = t, t.addEventListener("MSPointerDown", i, !1), t._slider = o, t.addEventListener("MSGestureChange", n, !1), t.addEventListener("MSGestureEnd", s, !1)) : (g = function(e) {
							...
							var e = 500;
							(!b || Number(new Date) - v > e) && (t.preventDefault(), !f && o.transitions && (o.vars.animationLoop || (u /= 0 === o.currentSlide && 0 > u || o.currentSlide === o.last && u > 0 ? Math.abs(u) / h + 2 : 1), o.setProps(c + u, "setTouch")))
						}, y = function(e) {
							...
							t.removeEventListener("touchend", y, !1), a = null, r = null, u = null, c = null
						}, t.addEventListener("touchstart", g, !1))
					},
					resize: function() {
						!o.animating && o.is(":visible") && (m || o.doMath(), f ? g.smoothHeight() : m ? (o.slides.width(o.computedW), o.update(o.pagingCount), o.setProps()) : d ? (o.viewport.height(o.h), o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && g.smoothHeight(), o.newSlides.width(o.computedW), o.setProps(o.computedW, "setTotal")))
					},
					...
					if (o.vars.animationLoop || t === o.currentSlide || (o.direction = t > o.currentSlide ? "next" : "prev"), v && 1 === o.pagingCount && (o.direction = o.currentItem < t ? "next" : "prev"), !o.animating && (o.canAdvance(t, a) || i) && o.is(":visible")) {
						if (v && s) {
							...
							if (o.atEnd = 0 === t || t === o.count - 1, l.flexAnimate(t, !0, !1, !0, a), o.direction = o.currentItem < t ? "next" : "prev", l.direction = o.direction, Math.ceil((t + 1) / o.visible) - 1 === o.currentSlide || 0 === t) return o.currentItem = t, o.slides.removeClass(r + "active-slide").eq(t).addClass(r + "active-slide"), !1;
					...
					!o.animating && s && o.flexAnimate(o.getTarget("next"))
				}, o.pause = function() {
					...
					if (f) o.slides.css({
						...
						"init" === t && (o.viewport = n('<div class="' + r + 'viewport"></div>').css({
							overflow: "hidden",
							position: "relative"
						}).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, p && (i = n.makeArray(o.slides).reverse(), o.slides = n(i), o.container.empty().append(o.slides))), o.vars.animationLoop && !m && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== t && o.container.find(".clone").remove(), o.container.append(g.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(g.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))), o.newSlides = n(o.vars.selector, o), e = p ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset, d && !m ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
							o.newSlides.css({
								display: "block"
							}), o.doMath(), o.viewport.height(o.h), o.setProps(e * o.h, "init")
					...
					o.doMath(), m || (t < o.currentSlide ? o.currentSlide += 1 : t <= o.currentSlide && 0 !== t && (o.currentSlide -= 1), o.animatingTo = o.currentSlide), o.vars.controlNav && !o.manualControls && ("add" === e && !m || o.pagingCount > o.controlNav.length ? g.controlNav.update("add") : ("remove" === e && !m || o.pagingCount < o.controlNav.length) && (m && o.currentSlide > o.last && (o.currentSlide -= 1, o.animatingTo -= 1), g.controlNav.update("remove", o.last))), o.vars.directionNav && g.directionNav.update()
				}, o.addSlide = function(t, e) {
					var i = n(t);
					o.count += 1, o.last = o.count - 1, d && p ? void 0 !== e ? o.slides.eq(o.count - e).after(i) : o.container.prepend(i) : void 0 !== e ? o.slides.eq(e).before(i) : o.container.append(i), o.update(e, "add"), o.slides = n(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.added(o)
				}, o.removeSlide = function(t) {
					var e = isNaN(t) ? o.slides.index(n(t)) : t;
					o.count -= 1, o.last = o.count - 1, isNaN(t) ? n(t, o.slides).remove() : d && p ? o.slides.eq(o.last).remove() : o.slides.eq(t).remove(), o.doMath(), o.update(e, "remove"), o.slides = n(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.removed(o)
				}, g.init()
		...
		r.nextTick = function(t) {
			...
			l.push(new o(t, e)), 1 !== l.length || c || setTimeout(n, 0)
		...
		var o = i(2),
			s = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
		...
		}, n.utils = a, t.exports = o.iScroll = n
	}, function(t, e, i) {
		"use strict";
		...
		c.DEFAULTS = {
			...
			if (!this.active && this.$element.length) {
				t && (this.relatedTarget = t), this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd)), n && this.$element.show(), this.active = !0, e.trigger(o.Event("open.modal.amui", {
					relatedTarget: t
				})), this.dimmer.open(e), e.show().redraw(), n || this.isActions || (s && (r.width = parseInt(s, 10) + "px"), a && (r.height = parseInt(a, 10) + "px"), this.$dialog.css(r)), e.removeClass(i.className.out).addClass(i.className.active), this.transitioning = 1;
				var c = function() {
			...
			if (this.active) {
				var e = this.$element,
					i = this.options,
					n = this.isPopup;
				this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd), this.dimmer.close(e, !0)), this.$element.trigger(o.Event("close.modal.amui", {
					relatedTarget: t
			...
			}), s.on("click.confirm.modal.amui", function() {
		...
		function n(t, e) {
			...
			return this.each(function() {
				var n = o(this),
					...
					a = o.extend({}, "object" == typeof t && t);
				s || (n.data("amui.offcanvas", s = new c(this, a)), (!t || "object" == typeof t) && s.open(e)), "string" == typeof t && s[t] && s[t].apply(s, i)
			})
		}
		var o = i(1),
			s = i(2);
		...
		var a, r = o(window),
			l = o(document),
			c = function(t, e) {
				this.$element = o(t), this.options = o.extend({}, c.DEFAULTS, e), this.active = null, this.bindEvents()
			};
		c.DEFAULTS = {
			duration: 300,
			effect: "overlay"
			...
			if (i.length && !i.hasClass("am-active")) {
				...
				}).width(), s.css("margin-top", -1 * a.y), setTimeout(function() {
				...
				}), s.on("keydown.offcanvas.amui", function(t) {
			...
			}, 0), r.css("margin-left", "").one(s.support.transition.end, function() {
				e()
		...
		}, o.fn.offCanvas = n, l.on("click.offcanvas.amui", "[data-am-offcanvas]", function(t) {
			t.preventDefault();
			var e = o(this),
		...
		a.DEFAULTS = {
			...
			var e, i = this,
				s = this.$element;
			this.options.target || (this.$popover = this.getPopover(), this.setContent()), e = this.$popover, e.appendTo(n("body")), this.sizePopover(), s.on("open.popover.amui", function() {
				n(window).on("resize.popover.amui", o.utils.debounce(t, 50))
			}), s.on("close.popover.amui", function() {
			...
			for (var t = "popover.amui", e = this.options.trigger.split(" "), i = e.length; i--;) {
				...
				if ("click" === o) this.$element.on("click." + t, n.proxy(this.toggle, this));
					...
					this.$element.on(s + "." + t, n.proxy(this.open, this)), this.$element.on(a + "." + t, n.proxy(this.close, this))
				}
			}
		}, a.prototype.destroy = function() {
			this.$element.off(".popover.amui").removeData("amui.popover"), this.$popover.remove()
		}, o.plugin("popover", a), o.ready(function(t) {
			...
			o = function() {
				...
				l.configure = function(t) {
						...
						return o.offsetWidth, h(function(t) {
							"" === c.positionUsing && (c.positionUsing = l.getPositioningCSS()), u(s, i(e, a, r)), 1 === e ? (u(o, {
								transition: "none",
								opacity: 1
					...
					function() {
						...
						}), c.showSpinner || (n = i.querySelector(c.spinnerSelector), n && r(n)), h != document.body && o(h, "nprogress-custom-parent"), h.appendChild(i), i
					}, l.remove = function() {
		...
		var n = i(1),
			...
			c = function(t, e) {
				this.$element = n(t), this.$body = n(document.body), this.options = n.extend({}, c.DEFAULTS, e), this.$pureview = n(this.options.tpl).attr("id", o.utils.generateGUID("am-pureview")), this.$slides = null, this.transitioning = null, this.scrollbarWidth = 0, this.init()
			};
		c.DEFAULTS = {
			...
			}), o.find(".am-pureview-direction").on("click.direction.pureview.amui", "li", function(e) {
				e.preventDefault(), n(this).is(".am-pureview-prev") ? t.prevSlide() : t.nextSlide()
			}), o.find(e.selector.nav).on("click.nav.pureview.amui", "li", function() {
				var e = t.$navItems.index(n(this));
				t.activate(t.$slides.eq(e))
			}), o.find(e.selector.close).on("click.close.pureview.amui", function(e) {
				e.preventDefault(), t.close()
			...
			this.imgUrls = this.imgUrls || [], l && (1 === l && i.addClass(e.className.onlyOne),
				r.not("[" + c + "]").each(function(e, i) {
					var r, l;
					"A" === i.nodeName ? (r = i.href, l = i.title || "") : (r = n(i).data("rel") || i.src, r = o.utils.getAbsoluteUrl(r), l = n(i).attr("alt") || ""), i.setAttribute(c, "1"), t.imgUrls.push(r), s = s.add(n('<li data-src="' + r + '" data-title="' + l + '"></li>')), a = a.add(n("<li>" + (e + 1) + "</li>"))
			...
			if (!t.data(i)) {
				...
				a.data("amui.pinchzoom", new s(a[0], {})), t.data("image-appended", !0)
			}
			e && e.call(this)
			...
			i.find("." + r).is(t) || this.transitioning || (this.loadImage(t, function() {
				o.utils.imageLoader(t.find("img"), function(e) {
		...
		}, o.plugin("pureview", c), o.ready(function(t) {
		...
		var n = i(1),
			...
			s = function(t, e) {
				if (o.support.animation) {
					this.options = n.extend({}, s.DEFAULTS, e), this.$element = n(t);
					var i = function() {
						o.utils.rAF.call(window, n.proxy(this.checkView, this))
					}.bind(this);
					this.$window = n(window).on("scroll.scrollspy.amui", i).on("resize.scrollspy.amui orientationchange.scrollspy.amui", o.utils.debounce(i, 50)), this.timer = this.inViewState = this.initInView = null, i()
				}
			};
		s.DEFAULTS = {
			animation: "fade",
			...
			o.utils.rAF.call(window, n.proxy(this.checkView, this))
		}, o.plugin("scrollspy", s), o.ready(function(t) {
		...
		i(23);
		var s = function(t, e) {
			this.options = n.extend({}, s.DEFAULTS, e), this.$element = n(t), this.anchors = [], this.$links = this.$element.find('a[href^="#"]').each(function(t, e) {
			...
			this.$window = n(window).on("scroll.scrollspynav.amui", i).on("resize.scrollspynav.amui orientationchange.scrollspynav.amui", o.utils.debounce(i, 50)), i(), this.scrollProcess()
		};
		s.DEFAULTS = {
			className: {
				active: "am-active"
		...
		}, o.plugin("scrollspynav", s), o.ready(function(t) {
		...
		var s = function(t, e) {
			this.$element = n(t), this.options = n.extend({}, s.DEFAULTS, {
		...
		s.DEFAULTS = {
			...
			this.$selector = n(o.template(this.options.tpl, s)), this.$selector.css({
				width: this.options.btnWidth
			}), this.$element[0].disabled && this.$selector.addClass(i.disabledClass), this.$list = this.$selector.find(".am-selected-list"), this.$searchField = this.$selector.find(".am-selected-search input"), this.$hint = this.$selector.find(".am-selected-hint");
			...
			var e = this.$element,
				...
				n = [],
				s = e.find("optgroup");
			this.$originalOptions = this.$element.find("option"), this.multiple || null !== e.val() || this.$originalOptions.length && (this.$originalOptions.get(0).selected = !0), s.length ? s.each(function(e) {
				n.push({
					header: !0,
					group: e + 1,
					text: this.label
			...
			if (this.$shadowOptions.filter("." + i.selectedClass).each(function() {
					var i = n(this);
					o.push(i.find(".am-selected-text").text()), t || (s = s.add(e.$originalOptions.filter('[value="' + i.data("value") + '"]').prop("selected", !0)))
				}), t) {
				var a = n(t);
			...
			this.$element.val() || (o = [i.placeholder]), this.$status.text(o.join(", ")), this.initialized && this.$element.trigger("change")
			...
			this.$list.on("click", "> li", function(i) {
				var o = n(this);
				!o.hasClass(t.options.disabledClass) && !o.hasClass(e) && t.setChecked(this)
		...
		}, o.plugin("selected", s), o.ready(function(t) {
		...
		l.DEFAULTS = {
			...
			return t.sns.forEach(function(n, o) {
				if (l.SNS[n]) {
					var a, c = l.SNS[n];
					c.id = n, a = "mail" === n ? r + "&subject=" + t.desc : "sms" === n ? r : "?url=" + s + "&title=" + i, c.shareUrl = c.url + a, e.push(c)
				}
			}), o.template(t.tpl, n.extend({}, t, {
				sns: e
			}))
		...
		function o(t) {
			for (var e = [], i = 0; i < t.length; i++)
				for (var o = t.charCodeAt(i), s = n(o), a = 0; a < s.length; a++) e.push(s[a]);
			return e
		}
		...
		d.prototype.createDefault = function(t) {
			...
			for (var i = e.getContext("2d"), n = (this.options.width / t.getModuleCount()).toPrecision(4), o = this.options.height / t.getModuleCount().toPrecision(4), s = 0; s < t.getModuleCount(); s++)
			...
			for (var e, i, n, o, s = t.getModuleCount(), a = this.options.height / this.options.width, r = '<svg xmlns="http://www.w3.org/2000/svg" width="' + this.options.width + 'px" height="' + this.options.height + 'px" viewbox="0 0 ' + 10 * s + " " + 10 * s * a + '">', l = "<path ", h = ' style="stroke-width:0.5;stroke:' + this.options.foreground + ";fill:" + this.options.foreground + ';"></path>', u = ' style="stroke-width:0.5;stroke:' + this.options.background + ";fill:" + this.options.background + ';"></path>', d = 0; s > d; d++)
				for (var p = 0; s > p; p++) e = 10 * p, n = 10 * d * a, i = 10 * (p + 1), o = 10 * (d + 1) * a, r += l + 'd="M ' + e + "," + n + " L " + i + "," + n + " L " + i + "," + o + " L " + e + "," + o + ' Z"', r += t.modules[d][p] ? h : u;
			return r += "</svg>", c(r)[0]
		}, s.prototype = {
			constructor: s,
				...
				for (var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
					for (var i = 0; i < t.length; i++) {
						...
						if (null == this.modules[n][o])
							for (var s = -2; 2 >= s; s++)
								for (var a = -2; 2 >= a; a++) - 2 == s || 2 == s || -2 == a || 2 == a || 0 == s && 0 == a ? this.modules[n + s][o + a] = !0 : this.modules[n + s][o + a] = !1
					}
			},
			...
			createBytes: function(t) {
				for (var e = 0, i = 0, n = 0, o = this.rsBlock.length / 3, s = new Array, r = 0; o > r; r++)
					for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], h = this.rsBlock[3 * r + 2], u = 0; l > u; u++) s.push([h, c]);
				...
				for (var x = new Array(this.totalDataCount), C = 0, r = 0; i > r; r++)
					for (var m = 0; m < s.length; m++) r < d[m].length && (x[C++] = d[m][r]);
				for (var r = 0; n > r; r++)
					for (var m = 0; m < s.length; m++) r < p[m].length && (x[C++] = p[m][r]);
				return x
			},
		...
		for (var p = [1, 0, 3, 2], m = {
				...
				getLostPoint: function(t) {
					for (var e = t.getModuleCount(), i = 0, n = 0, o = 0; e > o; o++)
						for (var s = 0, a = t.modules[o][0], r = 0; e > r; r++) {
							var l = t.modules[o][r];
					...
					for (var r = 0; e > r; r++)
						for (var s = 0, a = t.modules[0][r], o = 0; e > o; o++) {
							var l = t.modules[o][r];
		...
		var n = i(1),
			...
			s = function(t, e) {
				var i = this;
				this.options = n.extend({}, s.DEFAULTS, e), this.$element = n(t), this.sticked = null, this.inited = null, this.$holder = void 0, this.$window = n(window).on("scroll.sticky.amui", o.utils.debounce(n.proxy(this.checkPosition, this), 10)).on("resize.sticky.amui orientationchange.sticky.amui", o.utils.debounce(function() {
					i.reset(!0, function() {
						i.checkPosition()
					})
		...
		s.DEFAULTS = {
			...
			return this.$holder = e.css("margin", 0).wrap(o).parent(), this.inited = 1, !0
			...
			var i = this.options,
				...
				a = function() {
					n.css({
						...
						left: "",
						margin: 0
					}), n.removeClass([s, i.className.animationRev, i.className.sticky, i.className.resetting].join(" ")), this.animating = !1, this.sticked = !1, this.offset = n.offset(), e && e()
				}.bind(this);
			n.addClass(i.className.resetting), !t && i.animation && o.support.animation ? (this.animating = !0, n.removeClass(s).one(o.support.animation.end, function() {
				a()
			...
			!this.sticked && l ? s.addClass(r) : this.sticked && !l && this.reset(), this.$holder.css({
		...
		}, o.plugin("sticky", s), n(window).on("load", function() {
		...
		function n(t) {
			...
			return this.each(function() {
				var n = o(this),
					...
					r = a.data("amui.tabs"),
					l = o.extend({}, s.utils.parseOptions(n.data("amTabs")), o.isPlainObject(t) && t);
		...
		var o = i(1),
			...
			c = function(t, e) {
				this.$element = o(t), this.options = o.extend({}, c.DEFAULTS, e || {}), this.transitioning = this.activeIndex = null, this.refresh(), this.init()
			};
		c.DEFAULTS = {
			selector: {
				nav: "> .am-tabs-nav",
			...
			if (this.$element.on("click.tabs.amui", e.selector.nav + " a", function(e) {
				...
				i.add(n), i.on("swipeleft", s.utils.debounce(function(e) {
					e.preventDefault(), t.goTo("next")
				}, 100)), i.on("swiperight", s.utils.debounce(function(e) {
			...
			var n = this.$tabNav,
					...
					//新加
				t.children("span").addClass("am-badge-warning-active");
					//t.siblings().find("span").toggleClass("am-badge-warning-active");
			...
			var n = this.options.activeClass,
				s = e.find("> ." + n),
				a = i && r && !!s.length;
			s.removeClass(n + " am-in"), t.addClass(n), a ? (t.redraw(), t.addClass("am-in")) : t.removeClass("am-fade");
			//新加
			t.siblings().find("span").removeClass("am-badge-warning-active");
			...
			if (i && e + 1 >= this.$navs.length || !i && 0 === e) {
				...
				l && o.addClass(n).on(l.end, function() {
					o.removeClass(n)
					
				})
			} else this.open(i ? e + 1 : e - 1)
		}, c.prototype.destroy = function() {
			this.$element.off(".tabs.amui"), a.off(this.$content[0], "swipeleft swiperight"), this._hammer && this._hammer.destroy(), o.removeData(this.$element, "amui.tabs")
		}, o.fn.tabs = n, s.ready(function(t) {
			o("[data-am-tabs]", t).tabs()
		}), o(document).on("click.tabs.amui.data-api", "[data-am-tabs] .am-tabs-nav a", function(t) {
			t.preventDefault(), n.call(o(this), "open")
		}), t.exports = s.tabs = c
	}, function(t, e, i) {
		"use strict";
		var n = i(1),
			o = i(2),
			s = function(t, e) {
				this.options = n.extend({}, s.DEFAULTS, e), this.$element = n(t), this.init()
			};
		s.DEFAULTS = {
		...
		var n = i(1),
			o = i(2),
			s = function(t, e) {
				this.options = n.extend({}, s.DEFAULTS, e), this.options.patterns = n.extend({}, s.patterns, this.options.patterns);
				var i = this.options.locales;
				!s.validationMessages[i] && (this.options.locales = "zh_CN"), this.$element = n(t), this.init()
			};
		s.DEFAULTS = {
			debug: !1,
			locales: "zh_CN",
			...
			markValid: function(t) {
				...
				i.addClass(e.validClass).removeClass(e.inValidClass), o.addClass("am-form-success").removeClass("am-form-error"), e.onValid.call(this, t)
			},
			markInValid: function(t) {
				var e = this.options,
					i = n(t.field),
					o = i.closest(".am-form-group");
				i.addClass(e.inValidClass + " " + e.activeClass).removeClass(e.validClass), o.addClass("am-form-error").removeClass("am-form-success"), e.onInValid.call(this, t)
			},
			validate: function(t) {},
			submit: null
		}, s.VERSION = "2.6.1", s.patterns = {
			...
			function e(t, e, a) {
				...
				a && (l = o.utils.debounce(l, a)), n.each(r, function(e, i) {
			...
			var i = this,
				s = this.$element,
				a = this.options;
			return a.H5validation && o.support.formValidation ? !1 : (s.attr("novalidate", "novalidate"), n.each(a.H5inputType, function(e, i) {
				...
				var n = s.find("." + a.patternClassPrefix + e);
				!n.attr("pattern") && n.attr("pattern", t(i))
			}), s.on("submit.validator.amui", function(t) {
			...
			if (o.debug && window.console && (console.log("Validate: value -> [" + u + ", regex -> [" + l + "], required -> " + d), console.log("Regex test: " + l.test(u) + ", Pattern: " + r)), !isNaN(p) && u.length > p && (g.valid = !1, g.tooLong = !0), !isNaN(m) && u.length < m && (g.valid = !1, g.customError = "tooShort"), !isNaN(f) && Number(u) < f && (g.valid = !1, g.rangeUnderflow = !0), !isNaN(v) && Number(u) > v && (g.valid = !1, g.rangeOverflow = !0), d && !u) g.valid = !1, g.valueMissing = !0;
				...
				var w = parseInt(s.attr("minchecked"), 10),
					y = parseInt(s.attr("maxchecked"), 10);
				!isNaN(w) && w > u && (g.valid = !1, g.customError = "checkedUnderflow"), !isNaN(y) && u > y && (g.valid = !1, g.customError = "checkedOverflow")
			} else r && !l.test(u) && u && (g.valid = !1, g.patternMismatch = !0);
			var b, T = function(t) {
				this.markField(t);
				var i = n.Event("validated.field.validator.amui");
				i.validity = t, s.trigger(i).data("validity", t);
				var o = c || h;
			...
			if ("function" == typeof o.validate && (b = o.validate.call(this, g)), b) {
				...
				return s.data("amui.dfdValidity", x.promise()), n.when(b).always(function(t) {
			...
			u.each(function() {
				var i = n(this),
					o = t.isValid(this),
					s = i.data("validity");
				a = !!o && a, r.push(s), o || (l = l.add(n(this), e));
				var u = i.data("amui.dfdValidity");
				if (u) c.push(u), h = !0;
				else {
					var d = new n.Deferred;
					c.push(d.promise()), d[o ? "resolve" : "reject"](s)
				}
			});
			var d = {
				valid: a,
			...
			if (!e.valid) {
				...
				return s.is("[data-am-selected]") && (s = s.next(".am-selected").find(".am-selected-btn")), s.focus(), i("invalid"), !1
			}
			return i("valid"), !0
			...
			}), i = o[e] || void 0, i && s.ERROR_MAP[e] && (i = i.replace(a, r.attr(s.ERROR_MAP[e]) || "\u89c4\u5b9a\u7684")), i
		...
		}, o.plugin("validator", s), o.ready(function(t) {
		...
		var n = i(2),
			o = {
				...
				set: function(t, e, i, n, o, s) {
					...
					i instanceof Date && (a += "; expires=" + i.toUTCString()), n && (a += "; path=" + n), o && (a += "; domain=" + o), s && (a += "; secure"), document.cookie = a
				},
				unset: function(t, e, i, n) {
					this.set(t, "", new Date(0), e, i, n)
				}
			};
		n.utils = n.utils || {}, t.exports = n.utils.cookie = o
	}, function(t, e, i) {
		"use strict";
		var n = i(2),
			o = function() {
		...
		(function(e) {
			...
			a.enabled = !a.disabled, t.exports = s.store = a
		}).call(e, function() {
			return this
		}())
	}, function(t, e, i) {
		...
		var o = i(1),
			s = i(2);
		o(window).on("load", n), t.exports = s.duoshuo = {
			VERSION: "2.0.1",
			init: n
		}
	}, function(t, e, i) {
		...
		function o() {
			...
			var d = {
				...
				m = new BMap.Geocoder;
			s == e && a == i ? m.getPoint(o, function(t) {
				t && (c.centerAndZoom(t, r), u.setPosition(t), c.addOverlay(u), c.openInfoWindow(p, t))
			}, "") : m.getLocation(h, function(t) {
				c.centerAndZoom(h, r), u.setPosition(h), c.addOverlay(u), o ? c.openInfoWindow(p, h) : c.openInfoWindow(new BMap.InfoWindow(o, d), h)
			})
		}
		var s = i(1),
			a = i(2),
		...
		var o = i(1),
			s = i(2);
		o(window).on("load", n), t.exports = s.mechat = {
			VERSION: "2.0.1",
			init: n
		}
	}, function(t, e, i) {
		...
		var a = function() {
			...
			i.find("a").not(".am-parent>a").on("click", function(t) {
				...
				l.filter(".am-parent").each(function(t) {
					n(this).attr("data-rel", "#am-menu-sub-" + t), n(this).find(".am-menu-sub").attr("id", "am-menu-sub-" + t).appendTo(o)
				}), i.append(o), r.wrap('<div class="am-menu-nav-wrap" id="am-menu-' + t + '">'), l.each(function(t) {
				...
				l.on("click", function() {
					var t = n(this);
					t.addClass("am-active").siblings().removeClass("am-active"), o.find(".am-menu-sub.am-in").collapse("close"), t.is(".am-parent") ? !t.hasClass(".am-open") && o.find(t.attr("data-rel")).collapse("open") : t.siblings().removeClass("am-open"), void 0 === e && (e = n(this).index() ? 0 : 1);
					var s, a = n(this).index() > e,
						l = n(this)[a ? "next" : "prev"](),
						h = l.offset() || n(this).offset(),
						u = i.offset(),
						d = parseInt(i.css("padding-left"));
					(a ? h.left + h.width > u.left + u.width : h.left < u.left) && (s = r.offset(), c.scrollTo(a ? u.width - h.left + s.left - h.width - d : s.left - h.left, 0, 400)), e = n(this).index()
				}), i.on("touchmove", function(t) {
					t.preventDefault()
				})
			})
		};
		n(a), t.exports = o.menu = {
			VERSION: "4.0.3",
			init: a
		}
	}, function(t, e, i) {
		...
		function n() {
			function t() {
				h.append(b), h.find("li").not(".am-navbar-more").slice(i() - 1).appendTo(y), n.append(y)
			}
		...
		var o = i(1),
			s = i(2),
			a = i(14);
		i(20), o.fn.scrollTable = function(t) {
			var e, i = o(this);
		...
		}, o(window).on("load", n), t.exports = s.paragraph = {
			VERSION: "2.0.1",
			init: n
		}
	}, function(t, e, i) {
