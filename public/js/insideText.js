; (function(oojs) {
    oojs.define({
            ...
            if (this.slot.setStatus(t.id, this.config.STATUS_RENDERED), this.validate(t)) {
                ...
                if (e) {
                    ...
                    if (i) {
                        ...
                        this.event.bind(i, "mousedown", oojs.proxy(this, this.removeHuaci)),
                        this.event.bind(i, "mouseup", oojs.proxy(this, this.huaci)),
        ...
        getScriptHTML: function(t, e) {
            ...
            t.ScriptId = i,
            t.paramObj.dcb = this.SET_DATA_JSONP,
            t.paramObj.dtm = this.config.STATIC_JSONP,
            t.paramObj.cec = "utf-8";
            var n = this.param.getPmpRequestUrl(t),
            o = document.createElement("script");
            o.id = t.ScriptId,
            o.src = n,
            o.charset = t.paramObj.cec,
            e.appendChild(o)
        },
        resChild: function(t) {
            for (var e = t.childNodes,
            i = 0; i < e.length; i++) if (this.delScript(e[i])) {
                if ("br" === e[i].nodeName.toLocaleLowerCase()) break;
                switch (e[i].nodeType) {
                case 3:
                    var n;
                    this.browser.ie < 9 && e[i].nodeValue && (n = e[i].nodeValue),
                    e[i].textContent && (n = e[i].textContent),
                    "undefined" != typeof n && null !== n && n.length > 200 && this.addHash(e[i]);
                    break;
                case 1:
                default:
                    this.resChild(e[i])
        ...
        addHash: function(t) {
            var e = this.getTag(t);
            if (e.innerHTML) {
                var i = this.lang.trim(e.innerHTML),
                n = [e, i];
                this.hashBox["item_" + this.itemIndex] = n,
                this.itemIndex++
            }
        },
        textNodeCompare: function() {
            if (!arguments[0] || null !== typeof arguments[0]) {
                ...
                if (t) {
                    var e = t.data.meta;
                    this.is_instan = +arguments[0].slots[0].conf.ext.instan,
                    this.iss = +arguments[0].slots[0].conf.ext.iss,
                    this.is_instan && (this.getFirstUrl = e[0].curl, this.is_iss && (this.iss = 1));
                    var i = 300;
        ...
        checkData: function(t) {
            for (var e = [], i = {},
            n = t.length, o = 0; n > o; o++) i["item_" + o] = t[o].title;
        ...
        byteLen: function(t) {
            for (var e = 0,
            i = 0; i < t.length; i++) t.charCodeAt(i) > 127 || 94 === t.charCodeAt(i) ? e += 2 : e++;
            return e
        },
        checkStr: function(t) {
            var t = t[1];
        ...
        huaci: function(t) {
            if (this.getFirstUrl) {
                ...
                if ("input" !== i.tagName.toLowerCase() && i.id !== this.baiduTip) {
                    var n = "";
                    document.selection ? n = document.selection.createRange().text: window.getSelection() && (n = window.getSelection().toString()),
                    n.length && "" !== n && n !== this.PreSelection && this.drawIcon(n, e)
                }
            }
        },
        drawIcon: function(t, e) {
            ...
            n = 5,
            o = 10,
            s = this.browser.ie < 9 ? e.clientX: e.pageX,
            r = 38,
            ...
            d.id = this.baiduTip,
            d.src = "//cpro.baidustatic.com/cpro/ui/noexpire/img/2.0.0/icon.png",
            d.style.cursor = "pointer",
            d.style.width = r + "px",
            d.style.height = r + "px",
            d.style.position = "absolute",
            d.style.top = parseInt(a, 10) - r - n + "px",
            d.style.left = s + n + "px",
            t.length > o && (t = t.substr(0, o)),
            d.alt = t,
            document.body.appendChild(d),
            this.event.bind(d, "click", oojs.proxy(this, this.openUrl))
        },
        removeHuaci: function(t) {
            if (this.getFirstUrl) {
                var e = t || window.event,
                i = e.target || e.srcElement,
                n = document.getElementById(this.baiduTip);
        ...
        openUrl: function(t) {
            ...
            o = document.getElementById(this.baiduTip),
